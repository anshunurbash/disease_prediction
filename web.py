...
st.set_page_config(page_title='Prediction ',
                   layout='wide',
                   page_icon="🧑‍⚕️")
diabetes_model=pickle.load(open(r"F:\disease_prediction\training_models\diabetes_model.sav",'rb'))
heart_disease_model=pickle.load(open(r"F:\disease_prediction\training_models\heart_model.sav",'rb'))
parkinson_model=pickle.load(open(r"F:\disease_prediction\training_models\parkinson.sav",'rb'))
